<?php
    ...
    <div class="card-body" style="width:360px; border:1px black solid">
        ...
        <div class="form-group row text-left mb-0 py-2">
            ...
            <div class="col-sm-8 py-1">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <h5 class="text-right font-weight-bold"><?=LigneAppro::total($commande->get("n"))?> DT</h5>
                </div>
                <table width="100%">
                    <tbody>
                            <tr>
                                <td class="">Prix HT</td>
                                <td class="text-right"><?=LigneAppro::total($commande->get("n"))?> DT</td>
                            </tr>
                            <tr>
                                <td class="">Taxe</td>
                                <td class="text-right">20 DT</td>
                            </tr>
                        </tbody>
                    </table>
                    <h6>-------------------------------</h6>
        ...
        <div class="row justify-content-center">
            <h5>SOCIETE PARTOUT INTER IMPORT EXPORT</h5>
