    ...
    <div id="main">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-md table-striped" id="table">
                                        ...
                                        <tbody>
                                            <?php
                                            include_once(__DIR__ . '/../../Metier/client.php');
                                                                ...
                                                                <div class="modal-body" id="<?=$t->get("n")?>">
                                                                    <div class="table-responsive">
                                                                        <table class="table table-md " id="table">
                                                                            ...
                                                                            <tbody>
                                                                                <?php
                                                                            include_once(__DIR__ . '/../../Metier/ligneCmd.php');
                                                                    ...
                                                                    <div class="card-text font-bold d-flex justify-content-between"
                                                                        style="margin: 0 2rem">
                                                                        <div></div>
                                                                        <div>Total : <?=LigneCmd::total($t->get("n"))?> DT</div>
                                                                    </div>
                                                                </div>
        ...
        <script>
            function print(ref){
            var mywindow = window.open(`http://localhost/Projet_Web_TP-main/Presentation/Commande/pdf.php?ref=${ref}`, 'PRINT', 'height=400,width=600');
            mywindow.focus(); 
            mywindow.print();
            }
        </script>